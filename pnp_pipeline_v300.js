/**
 * Описание: Минимальный конвейер Pick and Place 3.5.26 для словаря Dict/.
 * Версия: 3.5.26
...
function normalizeDict(dictLike, sourceMeta = {}) {
  ...
  return {
    ...
    version: String((dictLike && dictLike.version) || '3.5.26'),
...
<title>Pick and Place 3.5.26 Preview</title>
<style>
