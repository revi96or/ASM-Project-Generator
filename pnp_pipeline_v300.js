/**
 * Описание: Минимальный конвейер Pick and Place 3.6.0 для словаря Dict/.
 * Версия: 3.6.0
 * Автор: Новожилов Артем
 * Изменения 3.6.0: сохранены исправления парсера XLSX (parseWorksheetXmlRows) —
...
const APP_VERSION = String(packageJson && packageJson.version ? packageJson.version : '3.6.0');
