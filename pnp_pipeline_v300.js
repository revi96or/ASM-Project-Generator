/**
 * Описание: Минимальный конвейер Pick and Place 3.5.27 для словаря Dict/.
 * Версия: 3.5.27
...
function normalizeDict(dictLike, sourceMeta = {}) {
  ...
  return {
    ...
    version: String((dictLike && dictLike.version) || '3.5.27'),
...
<title>Pick and Place 3.5.27 Preview</title>
<style>
