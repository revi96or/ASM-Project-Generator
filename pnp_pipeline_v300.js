/**
 * Описание: Минимальный конвейер Pick and Place 3.5.25 для словаря Dict/.
 * Версия: 3.5.25
...
function normalizeDict(dictLike, sourceMeta = {}) {
  ...
  return {
    ...
    version: String((dictLike && dictLike.version) || '3.5.25'),
...
<title>Pick and Place 3.5.25 Preview</title>
<style>
